...
export default class FeedCardFour extends React.Component {
	...
	render() {
		...
		return <TouchableWithoutFeedback
				onPress={this.onFeedCardFourPress}>
				<View
					...
					<View
						...
						<Text
							style={styles.redWineAndMintSoText}>Cured Vegetables & Mutton</Text>
						<View
							style={{
								flex: 1,
							}}/>
